  ...
  static getCompatibleDependencies(angularVersion: string): CompatibleVersion[] {
    const versionMap: Record<string, CompatibleVersion[]> = {
      ...
      '21': [
        ...
        // NgRx
        { name: '@ngrx/store', version: '^21.0.0', type: 'dependencies' },
        { name: '@ngrx/effects', version: '^21.0.0', type: 'dependencies' },
        { name: '@ngrx/entity', version: '^21.0.0', type: 'dependencies' },
        { name: '@ngrx/router-store', version: '^21.0.0', type: 'dependencies' },

        // PrimeNG
        { name: 'primeng', version: '^21.0.0', type: 'dependencies' },
        { name: 'primeicons', version: '^8.0.0', type: 'dependencies' },

        // ng-bootstrap
        { name: '@ng-bootstrap/ng-bootstrap', version: '^20.0.0', type: 'dependencies' },

        // Angular PWA
        { name: '@angular/service-worker', version: '^21.0.0', type: 'dependencies' },

        // Testing
        { name: '@angular/cdk/testing', version: '^21.0.0', type: 'devDependencies' },
  ...
  static getMigrationNotes(packageName: string, angularVersion: string): string | undefined {
    const migrationNotes: Record<string, Record<string, string>> = {
      '@angular/flex-layout': {
        ...
        '21': 'Angular Flex Layout is no longer maintained. Use CSS Grid and Flexbox instead.'
      }
    };
