...
class UpgradePathCalculator {
     ...
     */
    async calculatePath(currentVersion, targetVersion, options) {
     ...
     */
    generateVersionSequence(fromMajor, toMajor) {
     ...
     */
    async createUpgradeSteps(versionSequence, options) {
        const steps = [];
     ...
     */
    async createUpgradeStep(fromVersion, toVersion, options) {
     ...
     */
    getValidationSteps(version, options) {
        const validations = [
            {
                type: 'build',
     ...
     */
    async optimizePath(path, projectAnalysis, options) {
     ...
     */
    getAlternativePaths(currentVersion, targetVersion) {
...
exports.UpgradePathCalculator = UpgradePathCalculator;
//# sourceMappingURL=UpgradePathCalculator.js.map